...
\vspace{0.05cm}
\noindent
\textcolor{red}{Table~\ref{tab:far_eer} reports FAR/EER of forget probes vs.\ the retain gallery on CASIA-Iris. CU tracks the Oracle closely (FAR@0.5 $3.83\%$ vs.\ $3.10\%$; EER $24.99\%$ vs.\ $21.69\%$), both rising similarly over \textit{Before} ($1.64\%$), so the small increase stems from removing identities, not from CU.}
...
\end{tabular}}
\vspace{0.08cm}
\caption{\textcolor{red}{FAR/EER of forget probes vs.\ retain gallery (CASIA-Iris).}}
\label{tab:far_eer}
\end{table}
...
\begin{figure}[htbp]
    ...
    \caption{\textcolor{red}{Attention maps: retrained/CU models disperse attention off-face only for forget identities.}}
