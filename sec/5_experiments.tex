...
\vspace{0.05cm}
\noindent
Table~\ref{tab:far_eer} reports FAR/EER of forget probes vs.\ the retain gallery on CASIA-Iris. CU tracks the Oracle closely (FAR@0.5 $3.83\%$ vs.\ $3.10\%$; EER $24.99\%$ vs.\ $21.69\%$), both rising similarly over \textit{Before} ($1.64\%$), so the small increase stems from removing identities, not from CU.
